...
class getTwigService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 5).'/packages/error-monitoring-bundle/src/Twig/ReplayExtension.php';
        include_once \dirname(__DIR__, 5).'/packages/error-monitoring-bundle/src/Service/SessionReplayManager.php';
        ...
        $container->privates['twig'] = $instance = new \Twig\Environment($a, ['strict_variables' => true, 'cache' => ($container->targetDir.''.'/twig'), 'charset' => 'UTF-8', 'debug' => true, 'autoescape' => 'name']);
        ...
        $instance->addExtension(new \Makfly\ErrorMonitoringBundle\Twig\ReplayExtension(new \Makfly\ErrorMonitoringBundle\Service\SessionReplayManager($c, 'http://localhost:3333', 'ew_live_T4cBfRJ6oGvQi5uXBfcMp9OayyZF0dHF', true, 1.0, '1.0.0-demo')));
