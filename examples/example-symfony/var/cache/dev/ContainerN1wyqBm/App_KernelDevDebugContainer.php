...
class App_KernelDevDebugContainer extends Container
{
    ...
    protected static function getEventDispatcherService($container)
    {
        ...
        $instance->addListener('kernel.exception', [#[\Closure(name: 'Makfly\\ErrorMonitoringBundle\\EventSubscriber\\ExceptionSubscriber')] fn () => ($container->privates['Makfly\\ErrorMonitoringBundle\\EventSubscriber\\ExceptionSubscriber'] ?? $container->load('getExceptionSubscriberService')), 'onException'], 0);
    ...
    protected static function getHttpKernelService($container)
    {
        ...
        $b->allowControllers(['App\\Kernel', 'App\\Controller\\TestController']);
    ...
    private function getDynamicParameter(string $name)
    {
        ...
        $value = match ($name) {
            ...
            'kernel.secret' => $container->getEnv('default:default_secret:APP_SECRET'),
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.bundles' => [
                ...
                'ErrorMonitoringBundle' => 'Makfly\\ErrorMonitoringBundle\\ErrorMonitoringBundle',
            ],
            'kernel.bundles_metadata' => [
                ...
                'ErrorMonitoringBundle' => [
                    'path' => (\dirname(__DIR__, 5).'/packages/error-monitoring-bundle/src'),
                    'namespace' => 'Makfly\\ErrorMonitoringBundle',
                ],
            ],
            'kernel.charset' => 'UTF-8',
            'kernel.container_class' => 'App_KernelDevDebugContainer',
            'default_secret' => 'ThisIsADevSecretChangeInProduction123!',
            ...
            'error_monitoring.endpoint' => 'http://localhost:3333',
            'error_monitoring.api_key' => 'ew_live_T4cBfRJ6oGvQi5uXBfcMp9OayyZF0dHF',
            'error_monitoring.environment' => 'dev',
            'error_monitoring.release' => '1.0.0-demo',
            'error_monitoring.replay.enabled' => true,
            'error_monitoring.replay.sample_rate' => 1.0,
            'console.command.ids' => [
