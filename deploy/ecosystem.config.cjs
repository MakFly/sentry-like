  ...
  apps: [
    {
      ...
      env: {
        ...
        BETTER_AUTH_URL: "https://api.error-watch.tilvest.com",
        ADMIN_API_KEY: "ew_admin_CHANGE_ME",
        API_KEY_HASH_SECRET: "up1VGPB5f9qQaFMySOGV2AOqKj01y8rC",
        DASHBOARD_URL: "https://error-watch.tilvest.com",
        API_URL: "https://api.error-watch.tilvest.com",
        LOG_LEVEL: "info",
      },
    },
    {
      ...
      env: {
        ...
        NEXT_PUBLIC_APP_URL: "https://error-watch.tilvest.com",
        NEXT_PUBLIC_MONITORING_API_URL: "https://api.error-watch.tilvest.com",
      },
    },
  ],
};
