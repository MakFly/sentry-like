        ...
        <CardContent className="space-y-6">
          ...
          <div className="flex gap-2">
            ...
            <Button onClick={generateKey} disabled={createKeyMutation.isPending || !newKeyName.trim()}>
              ...
              {createKeyMutation.isPending ? t("creating") : t("newKey")}
            </Button>
          </div>
          ...
          {newlyCreatedKey && (
            <div className="rounded-lg border border-emerald-500/30 bg-emerald-500/10 p-4">
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="font-medium text-emerald-500">{t("keyCreatedTitle")}</span>
              </div>
                ...
                >
                  ...
                  <div className="flex items-center gap-4">
                    <div className="text-right text-xs text-muted-foreground">
                      <p>{t("createdLabel")} {new Date(key.createdAt).toLocaleDateString()}</p>
                      <p>{t("usedLabel")} {key.lastUsedAt ? new Date(key.lastUsedAt).toLocaleDateString() : t("neverUsed")}</p>
                    </div>
                    <Button
                      variant="ghost"
                      size="icon"
